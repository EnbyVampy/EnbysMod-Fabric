...
public class DisplayPlatformEntity extends BlockEntity implements DisplayBlockInventory, TickableBlockEntity{
    private ItemStack storedItem = ItemStack.EMPTY;
    private final DefaultedList<ItemStack> items = DefaultedList.ofSize(1, ItemStack.EMPTY);

    public DisplayPlatformEntity(BlockEntityType<?> type, BlockPos pos, BlockState state) {
